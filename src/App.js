      ...
      <div className="main-container">
        ...
        >
          ...
          <div className="nav-container">
            <nav className="nav">
              <div className="title">Nap Time</div>
            </nav>
          </div>
              ...
              <div className="dropdown">
                ...
                <div className="dropdown-content">
                  <RangeSlider
                    ...
                    interval={20}
                    react={{
                      and: ["DateRangeSensor", "PeopleSensor"]
                    }}
          ...
          <div className="result-map-container">
            <ReactiveMap
                      ...
                      <div key={data._id} className="card">
                        ...
                        <div>
                          ...
                          <p className="card__info">
                            {data.room_type} · {data.accommodates} guest
                          </p>
                        </div>
                      </div>
                    ))}
              ...
              react={{
                and: ["PeopleSensor", "PriceSensor", "DateRangeSensor", "search"]
              }}
            />
          </div>
        </ReactiveBase>
